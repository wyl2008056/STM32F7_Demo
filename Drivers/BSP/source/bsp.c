...
#define BSP_VERSION_MAIN   (0x02) /*!< [31:24] main version */
#define BSP_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define BSP_VERSION_SUB2   (0x02) /*!< [15:8]  sub2 version */
#define BSP_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define BSP_VERSION        ((BSP_VERSION_MAIN << 24)|(BSP_VERSION_SUB1 << 16)\
                           |(BSP_VERSION_SUB2 << 8 )|(BSP_VERSION_RC))
